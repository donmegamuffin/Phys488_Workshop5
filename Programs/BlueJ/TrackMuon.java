...
class TrackMuon
{
    ...
    public static void main (String [] args ) throws IOException
    {
    	...
    	// Eloss class: ...
    	EnergyLoss ironEloss = new EnergyLoss(26,55.845,7.87);                                 //TASK 2
    	// MCS class: ...
    	MCS ironMS = new MCS(26,55.845,7.87,1.);                                               //TASK 2
    	...
    	for (int n = 0; n < numberOfMuons; n++) 
    	{
    	    ...
    	    while (x < ironThickness && nsteps < nmax)  { // Note the 2 conditions here to avoid infinite loop
        		...
        		double theta0 = ironMS.theta_0(muonMomentum);                                                   //TASK 2
        		// smear theta by a Gaussian random angle with mean 0 and sigma=thetaT
        		theta = (theta0 + randGen.nextGaussian()*ironMS.findSigma(muonMomentum));
        		...
        		double energyloss = ironEloss.getEnergyLoss(muonMomentum);
